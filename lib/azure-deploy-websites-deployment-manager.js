...
AzureWebSiteDeploymentManager.prototype.deploy = function (sourceDir, excludes, commitMessage) {
    var self = this;
    ...
    // start deploymnet
    return gitDeploymentManager.deploy(sourceDir, excludes, commitMessage);
};
