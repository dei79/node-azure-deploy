var AzureGitDeploymentManager= require('./azure-deploy-git-deployment-manager.js').AzureGitDeploymentManager;
...
AzureWebSiteDeploymentManager.prototype.deploy = function (sourceDir) {
    ...
    var gitDeploymentManager = new AzureGitDeploymentManager(repositoryUri, self.azureUserName, self.azurePassword);

    // start deploymnet
    return gitDeploymentManager.deploy(sourceDir);
};
